...
where product.categories_id=categories.id and categories.status=1 and product.status=1 and product.cour_status=1 order by product.id desc";
				...
				<div class="col-xl-4 col-lg-6 col-md-6">
					<div class="box_grid wow">
						<figure class="block-reveal">
							...
							<a href="product.php?id=<?php echo $rows['id']?>"><img style="height: 40vh; width:100%;" src="<?php echo PRODUCT_IMAGE_SITE_PATH.$rows['image']?>" class="img-fluid" alt=""></a>
							<div class="price"> &#x20B9; <?php echo $rows['price']?></div>
							<div class="preview"><span>Preview course</span></div>
						</figure>
						<div class="wrapper">
							
							<small> <?php echo $rows['categories']?> </small>

...
if(isset($_POST['submit'])){
	...
	if($msg==''){
		if(isset($_GET['id']) && $_GET['id']!=''){
			mysqli_query($con,"update users set email='$email', password='$password',lname='$lname',fname='$fname',mobile='$mobile', where id='$id'");
		}else{
			$added_on=date('Y-m-d h:i:s');
			mysqli_query($con,"insert into users(email, password, fname, lname, mobile,added_on) 

...
<li>
				...
				<span><a href="#">Hi, <?php echo $_SESSION['USER_NAME']?></a></span>
					...
					<ul>
						...
						<li><a href="my_order.php">My Courses</a></li>
				...
				<li><span><a href="cart.php" class="icon-basket-2" style="font-size:1.2rem">(<?php echo $totalProduct?>)</a></span> </li>
